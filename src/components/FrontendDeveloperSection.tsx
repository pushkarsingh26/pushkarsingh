...
export default function FrontendDeveloperSection() {
  ...
  return (
    ...
    animate-[shine_4s_linear_infinite]"
        >
          Creating AI-powered products using LLMs, Retrieval-Augmented Generation (RAG), AI Agents, and modern backend technologies.
        </motion.p>
        ...
        >
          {["Python", "FastAPI", "Langchain", "RAG"].map((tech) => (
            <div
              key={tech}
              className="
