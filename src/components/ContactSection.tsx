...
export default function ContactSection() {
    ...
    const [status, setStatus] = useState<"idle" | "submitting" | "success" | "done">("idle");
    ...
    const handleSend = () => {
        ...
        const accessKey = atob("MTgwOTI3YjItYTFhMy00NTkyLTkzZDYtMTE0ZDMxMzJjZjQx");
    ...
    animate-[shine_4s_linear_infinite]"
                        ...
                        <div className="flex items-center justify-center lg:justify-start gap-5 mt-2">
                            ...
                            {/* gmail */}
                            <a
                                href="mailto:pushkarcd123@gmail.com"
                            ...
                            <div className="relative z-10 p-6 sm:p-7 space-y-6">
                                ...
                                <div className="space-y-3">
                                    ...
                                    <p className="text-sm text-white/35 leading-relaxed">
                                        Send me a message directly to my email—no spam, just real connection.
                                    </p>
                                </div>
                                ...
                                {status === "idle" || status === "submitting" ? (
                                    ...
                                    <div className="space-y-4">
                                        ...
                                        <div className="relative group/email">
                                            <input
                                                ...
                                                hover:shadow-[0_0_20px_rgba(255,255,255,0.05)]
                                                border border-white/10
                                                group-hover/email:border-white/20
                                                text-white placeholder:text-white/20
                                                outline-none transition-all duration-300
                                                focus:border-white/30
                                                focus:shadow-[0_0_20px_rgba(255,255,255,0.05)]
                                        ...
                                        <div className="relative group/subject">
                                            <input
                                                ...
                                                hover:shadow-[0_0_20px_rgba(255,255,255,0.05)]
                                                border border-white/10
                                                group-hover/subject:border-white/20
                                                text-white placeholder:text-white/20
                                                outline-none transition-all duration-300
                                                focus:border-white/30
                                                focus:shadow-[0_0_20px_rgba(255,255,255,0.05)]
                                        ...
                                        <button
                                            onClick={handleSend}
                                            disabled={!form.name || !form.email || !form.subject || !form.message || status === "submitting"}
                                    ...
                                    <div className="flex flex-col items-center justify-center text-center space-y-5 py-12 animate-[scaleIn_0.4s_ease]">
                                        <div className="w-20 h-20 rounded-full bg-green-500/10 border border-green-500/30 flex items-center justify-center text-green-400 shadow-[0_0_30px_rgba(34,197,94,0.2)]">
                                            <svg className="w-10 h-10" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={3}>
                                                <path strokeLinecap="round" strokeLinejoin="round" d="M5 13l4 4L19 7" />
                                            </svg>
                                        </div>
                                        <div className="space-y-2">
                                            <h3 className="text-2xl font-bold tracking-tight text-white">Message sent to mail!</h3>
                                        ...
                                        <button
                                            ...
                                            className="px-6 py-2.5 rounded-full border border-white/10 hover:border-white/30 hover:bg-white/5 text-xs font-semibold tracking-widest uppercase transition-all duration-300 active:scale-95"
                                        >
                                            Send Another
                                        </button>
                                    </div>
  ...
  animate-[headingReveal_1s_cubic-bezier(0.22,1,0.36,1)_0.15s_forwards]"
    ...
    bg-clip-text text-transparent"
                    ...
                    <div className="flex flex-wrap items-center justify-center gap-5">
                        {/* Instagram */}
                        <a
                            href="https://www.instagram.com/pushkarsingh_26"
                            target="_blank"
    ...
    hover:-translate-y-1.5 hover:scale-105 hover:border-white/30"
                        ...
                        {/* GitHub */}
                        <a
                            href="https://github.com/pushkarsingh26"
                            target="_blank"
                            rel="noopener noreferrer"
                            aria-label="GitHub"
                            className="group relative grid h-14 w-14 place-items-center overflow-hidden rounded-[20px]
        ...
        hover:-translate-y-1.5 hover:scale-105 hover:border-white/40"
                        ...
                        {/* LinkedIn */}
                        <a
                            href="https://www.linkedin.com/in/pushkar-chhokar"
                            target="_blank"
                            rel="noopener noreferrer"
                            aria-label="LinkedIn"
                            className="group relative grid h-14 w-14 place-items-center overflow-hidden rounded-[20px]
        ...
        hover:-translate-y-1.5 hover:scale-105 hover:border-blue-400/50"
                        >
                            <div className="absolute inset-0 bg-gradient-to-br from-blue-600/18 via-sky-500/10 to-transparent opacity-0 transition-opacity duration-500 group-hover:opacity-100" />
                            <div className="absolute inset-[1px] rounded-[19px] bg-[#0b0b12]/80" />
        ...
        hover:-translate-y-1.5 hover:scale-105 hover:border-red-400/50"
                        >
                            ...
                            <FaEnvelope className="relative z-10 text-[30px] text-white transition-all duration-500 group-hover:scale-110 group-hover:text-red-400" />
                        </a>
                    </div>
