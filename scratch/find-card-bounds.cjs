...
try {
  ...
  // We scan for white or off-white pixels which represent the card face.
  // The card has a white base background. Let's look for R > 230, G > 230, B > 230, A > 200.
  for (let y = 0; y < height; y++) {
    ...
    for (let x = 0; x < width; x++) {
      ...
      // Card face is white/light-grey background in the texture atlas
      const isWhite = r > 230 && g > 230 && b > 230 && a > 200;
  ...
  console.log('White card background bounding box:');
